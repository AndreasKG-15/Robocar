...
try:
    while True:
        ...
        if sensor_left_flag and sensor_right_flag:
            if current_time - left_sensor_time < 0.01 and current_time - right_sensor_time < 0.01:
        ...
        if sensor_left_flag and back_sensor_right_flag:
            if current_time - left_sensor_time < 0.01 and current_time - back_sensor_right_time < 0.01:
        ...
        if sensor_right_flag and back_sensor_left_flag:
            if current_time - right_sensor_time < 0.01 and current_time - back_sensor_left_time < 0.01:
        ...
        if sensor_left_flag and back_sensor_left_flag:
            if current_time - left_sensor_time < 0.01 and current_time - back_sensor_left_time < 0.01:
        ...
        if sensor_right_flag and back_sensor_right_flag:
            if current_time - right_sensor_time < 0.01 and current_time - back_sensor_right_time < 0.01:
